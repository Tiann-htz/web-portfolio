          ...
          {tabs.map((tab, index) => {
            ...
            return (
              <motion.button
                ...
                className="relative px-8 py-3.5 rounded-full font-semibold text-base font-['Nunito'] flex items-center gap-2.5 transition-all duration-300 overflow-hidden"
                style={isActive ? {
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {getSortedProjects().slice(0, 6).map((project, index) => (
                  ...
                  >
                    {/* Image */}
                    <div className="relative h-52 overflow-hidden bg-purple-950/30">
                      <Image
              ...
              {getSortedProjects().length > 6 && (
                ...
                >
                  <button
                    className="px-8 py-3.5 rounded-full text-white font-semibold font-['Nunito'] flex items-center gap-2 hover:scale-105 transition-all duration-300"
                    style={{
                      background: 'linear-gradient(135deg, #a855f7 0%, #ec4899 100%)',
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {certificatesData.slice(0, 6).map((cert, index) => (
                  ...
                  >
                    <div className="relative h-56 overflow-hidden bg-purple-950/20">
                      <Image
                        src={cert.image}
                        alt={cert.title}
                        fill
          ...
          {activeTab === 'techstack' && (
            ...
            >
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 gap-5">
                {techStackData.map((tech, index) => (
                  <motion.div
                    ...
                    className="group flex flex-col items-center justify-center gap-3 p-4 rounded-2xl border border-purple-500/15 bg-white/[0.03] backdrop-blur-md hover:border-purple-400/35 transition-all duration-300 cursor-default"
                  ...
                  >
                    ...
                    <span className="text-white text-xs font-semibold text-center font-['Nunito'] group-hover:text-purple-300 transition-colors">
                      {tech.name}
                    </span>
                  </motion.div>
                ))}
              ...
              >
                ...
                >
                  <div className="h-[1px] w-16 rounded-full" style={{ background: 'linear-gradient(90deg, transparent, #a855f7)' }} />
                  <h3
                    className="text-2xl font-bold font-['Cormorant_Garamond']"
                    style={gradientText}
                  >
                    Tools & IDE
                  </h3>
                  <div className="h-[1px] w-16 rounded-full" style={{ background: 'linear-gradient(90deg, #ec4899, transparent)' }} />
                </motion.div>
          ...
          {selectedProject && (
            ...
            >
              ...
              >
                ...
                <button
                  onClick={closeModal}
                  className="absolute top-5 right-5 w-10 h-10 rounded-full flex items-center justify-center transition-all z-10 hover:scale-110"
                ...
                <div className="grid md:grid-cols-2 gap-8 p-8">
                  ...
                  <div className="space-y-4">
                    <div
                      className="relative w-full h-72 rounded-2xl overflow-hidden bg-purple-950/30 cursor-pointer"
                  ...
                  <div className="space-y-5">
                    ...
                    {/* Visit Site button placeholder */}
                    {selectedProject.visitSite && (
                      <a
                        href={selectedProject.visitSite}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 px-6 py-3 rounded-full font-semibold font-['Nunito'] text-white hover:scale-105 transition-all duration-300"
                        style={{
                          background: 'linear-gradient(135deg, #a855f7 0%, #ec4899 100%)',
        ...
        <AnimatePresence>
          {selectedProjectImage && (
            <motion.div
              ...
              className="fixed inset-0 backdrop-blur-sm bg-black/80 z-[70] flex items-center justify-center p-6"
            >
              <motion.div
                initial={{ scale: 0.6, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
